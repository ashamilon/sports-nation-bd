    ...
    <div className="flex items-center space-x-2">
      ...
      {showText && (
        <div className="flex flex-col">
          <h1 className={`${textSizeClasses[size]} font-display font-bold text-brand-dark dark:text-white hidden sm:block`}>
            Sports Nation BD
          </h1>
          <p className="text-xs text-brand-medium dark:text-white hidden sm:block">Buy Your Dream Here</p>
        </div>
      )}
    </div>
  )
