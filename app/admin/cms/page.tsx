              ...
              {siteContent.map((content) => (
                <div key={content.id} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="font-medium">{content.title || content.key}</h3>
                      <p className="text-sm text-gray-600 mt-1">{content.category}</p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4">
              {countdowns.map((countdown) => (
                <div key={countdown.id} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="font-medium">{countdown.title}</h3>
                      <p className="text-sm text-gray-600 mt-1">Type: {countdown.type}</p>
                      <p className="text-sm text-gray-500 mt-1">
